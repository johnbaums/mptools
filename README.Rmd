...
habitat change, in temporal order. The interval between successive rasters
(i.e., the interval between time steps) is assumed to be constant. Below, we
create a `RasterStack` of rasters included with `mptools`, and pass it to
`mp_animate`.
